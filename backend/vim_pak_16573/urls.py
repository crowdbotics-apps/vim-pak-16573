"""vim_pak_16573 URL Configuration
...
admin.site.site_header = "Vim Pak"
admin.site.site_title = "Vim Pak Admin Portal"
admin.site.index_title = "Vim Pak Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Vim Pak API",
        default_version="v1",
        description="API documentation for Vim Pak App",
    ),
    public=True,
